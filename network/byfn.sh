...
function printHelp() {
  ...
  echo "    -c <channel name> - channel name to use (defaults to \"mycar\")"
  ...
  echo
  echo "	byfn.sh generate -c mycar"
  echo "	byfn.sh up -c mycar -s couchdb"
  echo "        byfn.sh up -c mycar -s couchdb -i 1.4.0"
  echo "	byfn.sh up -l node"
  echo "	byfn.sh down -c mycar"
  echo "        byfn.sh upgrade -c mycar"
  echo
...
# channel name defaults to "mycar"
CHANNEL_NAME="mycar"
